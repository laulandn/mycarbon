...
#define kMnMRecTypeBody "aoce AppleMail\252 M&M"
#define kMnMForwarderRecTypeBody "aoce AppleMail\252 Fwdr"
...
be compared in a case- and diacritical-sensitive manner (c \255 C \255 \215), use
eGenericSensitive.  If you want them to be compared in a case- and diacritical-
insensitive manner (c = C = \215), use eGenericInensitive.
...
change to ONLY service ServerGateway calls \321it will then be necessary to run
it co\320resident with an OCE toolbox].
...
a\320priori. Note: there will not be a seperate version numbers for each component
