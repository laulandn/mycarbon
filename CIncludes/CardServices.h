...
/*
	...
	Contains:	This file contains constants and data structures that describe
 	...
 	Version:	Technology: PCMCIA Software 2.0
				Package:	Universal Interfaces 2.1.1 in \322MPW Latest\323 on ETO# 19
...
/*	\324attributes\325 field values*/
...
/*	\324intType\325 field values*/
enum {
	kCSMemoryInterface			= 0x01,
	kCSMemory_And_IO_Interface	= 0x02
};

/*	\324present\325 field values*/
enum {
...
/*	\324cardValues\325 field values*/
enum {
...
/*	\324eventMask\325 field values (see above for Get/SetClientEventMask*/
/*----------------		CSGetStatus						----------------*/
...
/*	\324socketState\325 field values*/
enum {
...
/*	\324accessSpeed\325 field values*/
enum {
...
/*	\324attributes\325 field values (see GetClientInfo)*/
/*	kCSMemoryClient					= 0x0001,*/
/*	kCSIOClient						= 0x0004,*/
/*	kCSShareableCardInsertEvents	= 0x0008,*/
/*	kCSExclusiveCardInsertEvents	= 0x0010*/
