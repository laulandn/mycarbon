...
/* Compression Names */
#define NoneName PSTRINGCONST("not compressed")
#define ACE2to1Name PSTRINGCONST("ACE 2-to-1")
#define ACE8to3Name PSTRINGCONST("ACE 8-to-3")
#define MACE3to1Name PSTRINGCONST("MACE 3-to-1")
#define MACE6to1Name PSTRINGCONST("MACE 6-to-1")
