...
/*---------------------------------------------------------------------------*
 |                                                                           |
 |     <<< DisAsmLookup.h - Disassembler Lookup Routines Header File >>>     |
 |                                                                           |
 |                               Ira L. Ruben                                |
 |                                 06/16/87                                  |
 |                                                                           |
...
pascal void Disassembler(long	 DstAdjust,	 			/* Address correction					*/
	...
	=======================================================================
	Non PC-relative EA's     op.sz     EA's				; 'c\311' (for immediates)
  ...
  ========================================================================
		...
		3     (An)+                        (An)+
		4     -(An)                        -(An)
		5     \266(An)                        S(An) or just S (if An=A5, \266\2630)
	 6n     \266(An,Xn.Size*Scale)          S(An,Xn.Size*Scale)
	 ...
	 71     \266                            S
	 72     *\261\266                          S
	 73     *\261\266(Xn.Size*Scale)           S(Xn.Size*Scale)
	 73     (*\261\266,Xn.Size*Scale)          (S,Xn.Size*Scale)
	 73     ([*\261\266],Xm.Size*Scale,OD)     ([S],Xm.Size*Scale,OD)
	 73     ([*\261\266,Xn.Size*Scale],OD)     ([S,Xn.Size*Scale],OD)
  ...
  ========================================================================
	...
	All displacements (\266, BD, OD) are hexadecimal values shown as a byte ($XX),
	...
	made for "\266(An)", "BD,An", and "*\261\266" cases.
	...
	BaseReg = This determines the meaning of the Opnd value and supplies
						the base register for the "\266(An)", "BD,An", and "*\261\266" cases.
	...
	Opnd    = The contents of this LongInt is determined by the BaseReg parameter
						...
						For BaseReg = _PC_  (PC-relative effective address):
								Opnd contains the 32-bit address represented by "*\261\266" adjusted
	...
	(3). The caller can call first InitLookup (described below, a proc provided
			 ...
			 \245 PC-relative references
			 \245 Jump Table references
			 \245 Absolute address references
			 \245 Trap names
...
pascal void ModifyOperand(char *operand);
  ...
  The operand to be processed is	passed as the function's parameter which is
	...
	\245 There must have been exactly 2, 4, or 8 digits.
