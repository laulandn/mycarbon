...
enum {
	timingInvalid				= 0,							/* Unknown timing\311 force user to confirm.*/
...
enum {
	...
	kIsMonoDev					= 4,							/* Says whether there\325s an RGB (0) or Monochrome (1) connection. */
...
enum {
	kUnknownConnect				= 1,							/* Not sure how we\325ll use this, but seems like a good idea. */
	...
	kPanelFSTNConnect			= 14,							/* For use with fixed-in-place LCD FSTN (aka \322Supertwist\323) panels */
...
/* RawSenseCode
	...
	For 'standard' sense code hardware, the raw sense is obtained as follows:
		\245 Instruct the frame buffer controller NOT to actively drive any of the monitor sense lines
		\245 Read the state of the monitor sense lines 2, 1, and 0.  (2 is the MSB, 0 the LSB)
...
/* ExtendedSenseCode
	...
	(Note:  as described here, sense line 'A' corresponds to '2', 'B' to '1', and 'C' to '0')
		\245 Drive sense line 'A' low and read the values of 'B' and 'C'.  
		\245 Drive sense line 'B' low and read the values of 'A' and 'C'.
		\245 Drive sense line 'C' low and read the values of 'A' and 'B'.
...
enum {
	...
	kESCSeven19Inch				= 0x3A,							/* Third-Party 19\323						*/
