...
enum {
	kDummyDeviceID				= 0x0FF,						/* This is the ID of the dummy display, used when the last \322real\323 display is disabled.*/
...
/* \245\245\245 Move AVLocationRec to AVComponents.i AFTER AVComponents.i is created*/
