...
struct IOParam {
	...
	Ptr								ioMisc;
#ifdef __LATITUDE_LONG_ALIGNED__
        long							filler_to_ioFlFndrInfo;
#endif
	Ptr								ioBuffer;
	long							ioReqCount;
#ifdef __LATITUDE_LONG_ALIGNED__
        long							filler_to_ioFCBEOF;
#endif
	long							ioActCount;
	short							ioPosMode;
	long							ioPosOffset;
...
struct FileParam {
	...
	short							ioFDirIndex;
#ifdef __LATITUDE_LONG_ALIGNED__
    short filler_to_ioVCrDate;
#endif
	SInt8							ioFlAttrib;
	SInt8							ioFlVersNum;
	FInfo							ioFlFndrInfo;
#ifdef __LATITUDE_LONG_ALIGNED__
    long filler_to_ioVAlBlkSiz[2];
#endif
...
#ifdef __LATITUDE_LONG_ALIGNED__
    long filler_to_ioFCBStBlk;
#endif
	unsigned short					ioVAtrb;
#ifdef __LATITUDE_LONG_ALIGNED__
    short filler_to_ioFCBEOF;
#endif
	unsigned short					ioVNmFls;
	unsigned short					ioVDirSt;
	short							ioVBlLn;
#ifdef __LATITUDE_LONG_ALIGNED__
    short filler_to_ioPosOffset;
#endif
...
#ifdef __LATITUDE_LONG_ALIGNED__
    /*
     * We longword align csParam so clients can easily cast it to 
     * long* and dereference it.
     */
    short filler_pbh;
#endif
	short							ioCRefNum;
