...
Disassemble_CRBits 		 - Condition register field bits are referenced as bit numbers 0:31
												 ...
												 bits to be referenced using the format \322crN_X\323, where N is a 4-bit
												 CR field (0:7) and X is the bit \322name\323 in the field (\322LT\323, \322GT\323,
												 \322EQ\323, \322SO\323 for bits 0, 1, 2, and 3 respectively).  Note, this
...
Disassemble_CRFltBits  - Condition register field bits are referenced as bit numbers 0:31
												 ...
												 to Disassemble_CRBits to generate the references as \322crN_X\323,
												 except that the bits (X) are referenced as \322FX\323, \322FEX\323, \322VX\323 and
												 \322OX\323 for the four bits 0,1, 2, and 3 respectively.  This option
...
Disassemble_IBM				 - Apple assembler conventions are used for comments and invalid
												 ...
												 used for these.  A \322#\323 is used instead of a \322;\323 as the comment
												 character, and \322.long\323 is used instead of \322dc.l\323 for the invalid
					...
					thingToReplace = The kind of object and the associated value of that object to be
				                   ...
				                   Disassembler_Lookup_AbsAddress		address [1]
													 ...
													 [4] The lookup for SPRs is slightly different in that it is only
															 ...
															 according to the Disassemble_FieldErr option, i.e., it\325s
															 accepted but returns a status warning, or the instruction is
															 treated as invalid (\322DC.L 0xXXXXXXXX\323).
