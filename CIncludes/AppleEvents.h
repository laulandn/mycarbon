...
/* Constant for transaction ID\325s */
...
**************************************************************************/
/*
  Note: The following# defines map \322key\323 calls on AERecords into \322param\323 calls on 
  AppleEvents.  Although no errors are currently returned if AERecords are 
  passed to \322param\323 calls and AppleEvents to \322key\323 calls, the behavior of 
  this type of API-mixing is not explicitly documented in Inside Macintosh.  
  It just happens that the \322key\323 calls have the same functionality as their 
  \322param\323 counterparts.  Since none of the \322key\323 calls are currently available 
  in the PowerPC IntefaceLib, the# defines exploit the fact that \322key\323 and 
  \322param\323 routines can be used interchangeably, and makes sure that every 
  invokation of a \322key\323 API becomes an invokation of a \322param\323 API.
*/
