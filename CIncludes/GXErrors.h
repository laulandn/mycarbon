...
/*
 	...
 	Version:	Technology:	Quickdraw GX 1.1
 				Package:	Universal Interfaces 2.1.1 in \322MPW Latest\323 on ETO# 18
...
/* These levels tell how to validate memory manager blocks.  Choose any combination. */
	...
	gxApHeapValidation			= 0x0400,						/* check the memory manager\325s gxHeap after every mem. call */
	gxFontHeapValidation		= 0x0800,						/* check the system gxHeap as well */
	gxCheckApHeapValidation		= 0x1000,						/* check the memory manager\325s gxHeap if checking routine parameters */
