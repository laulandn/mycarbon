...
enum {
	...
	interruptsMaskedErr			= -624,							/*don\325t call with interrupts masked*/
...
enum {
	...
	notExactSizeErr				= -2206,						/* Can\325t do exact size requested */
	badDepthErr					= -2207,						/* Can\325t digitize into this depth */
	noDMAErr					= -2208,						/* Can\325t do DMA digitizing (i.e. can't go to requested dest */
...
/*	telNoTools			= -10101,		   unable to find any telephone tools */
	...
	telNoCommFolder				= -10106,						/* Communications/Extensions \304 not found */
...
/* Mirroring-Specific Errors */
	...
	kDMCantBlock				= -6224,						/*Mirroring is already on, can\325t Block now (call DMUnMirror() first).*/
...
enum {
	...
	dsBadPatchHeader			= 83,							/*SetTrapAddress saw the \322come-from\323 header*/
...
enum {
	dsNoFPU						= 90,							/*an FPU instruction was executed and the machine doesn\325t have one*/
...
/*System Errors that are used after MacsBug is loaded to put up dialogs since these should not cause MacsBug to stop, they must be in the range (30, 42, 16384-32767) negative numbers add to an existing dialog without putting up a whole new dialog*/
	dsMacsBugInstalled			= -10,							/*say \322MacsBug Installed\323*/
	dsDisassemblerInstalled		= -11,							/*say \322Disassembler Installed\323*/
	dsExtensionsDisabled		= -13,							/*say \322Extensions Disabled\323*/
	dsGreeting					= 40,							/*welcome to Macintosh greeting*/
	dsSysErr					= 32767,						/*general system error*/
/*old names here for compatibility\325s sake*/
...
enum {
	...
	dsSystemFileErr				= 43,							/*can\325t find System file to open (sad Mac only)*/
	dsHD20Installed				= -12,							/*say \322HD20 Startup\323*/
...
enum {
   ...
   fragNoContextIDs            = -2811,							/* no more context id\325s */
...
/* error codes */
	...
	tsmCantOpenComponentErr 	= -2509,						/* can\325t open the component */
