...
/*
	...
	Copyright \251 Apple Computer, Inc.  1995. All rights reserved.
*/
...
const unsigned char *kAppleToolManufacturerName= PSTRINGCONST("Apple Computer, Inc.");
const unsigned char *kGTAK01DeviceName= PSTRINGCONST("GeoPort Telecom Adapter");
