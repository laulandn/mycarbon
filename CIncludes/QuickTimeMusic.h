...
/*
 	...
 	Copyright:	\251 1984-1996 by Apple Computer, Inc.  All rights reserved.
...
enum {
	...
	kaiPictType					= 'pict',
	kaiWriterType				= '\251wrt',
	kaiCopyrightType			= '\251cpy',
	kaiOtherStrType				= 'str ',
...
struct SynthesizerDescription {
	...
	unsigned long 					latency;					/* response time in \265Sec */
...
enum {
	...
	kGenericMusicResInstrumentList = 3,							/* NmLs of names and shorts, categories prefixed by '\245\245' */
...
/*
	...
	future expansion:
		...
		\245 (1 0 0 0)		(8 bytes/event)
		\245 (1 1 0 0)		(N bytes/event)
		\245 (1 1 0 1)		(N bytes/event)
		\245 (1 1 1 0)		(N bytes/event)
