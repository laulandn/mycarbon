...
#ifdef _LATITUDE_
/*
 * YieldToAnyThread is really a call to YeldToThread(0).
 * Latitude's liblg/toolbox/auto/make-api needs to be modified to
 * handle this very unique case. Until then, change the selector
 * value to the bogus one listed in Inside Mac Threads Manager p. 1-81.
 */
 FOURWORDINLINE(0x42A7, 0x303C, 0x303C, 0xABF2);
#else
